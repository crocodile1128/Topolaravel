...
namespace PacketParser {
    public class NetworkHost : IComparable, System.Xml.Serialization.IXmlSerializable {
        ...
        public List<IPAddress> queriedIpList;
        public List<string> domainNameList;
        public List<string> queriedNetBiosNameList;
        public List<string> queriedDnsNameList;
        public List<string> httpUserAgentBannerList;
        public List<string> httpServerBannerList;
        public List<string> ftpServerBannerList;
        public List<string> dhcpVendorCodeList;
